...
<body>
    ...
    <main role="main" class="container mt-4">
        ...
        $id = $_GET['id'];
        $sql = "SELECT id, name, price, description, stock_quantity,
image_url, category FROM products WHERE id=$id";
        ...
        <div class="card">
            <div class="row">
                <div class="col-md-6 preview">
                    <div class="preview-pic">
                        <img src="<?= empty($prod[5]) ?
                                        '/Day6/assets/shared/img/default-image_600.png' :
                                        '/Day6/assets/uploads/' . basename($prod[5]) ?>" />
                    </div>
                ...
                <div class="col-md-6 details">
                    ...
                    <h4 class="price">Price: <span><?= $prod[2]
                                                    ?></span></h4>
                    <h5 class="sizes">sizes:
                        <span class="size" data-bs-toggle="tooltip"
                            title="Small">s</span>
                        <span class="size" data-bs-toggle="tooltip"
                            title="Medium">m</span>
                        <span class="size" data-bs-toggle="tooltip"
                    ...
                    <div class="action">
                        <button class="add-to-cart btn"
                            id="btnAddCart">Add to Cart</button>
                        <a class="like btn btn-outline-secondary"
                            href="#"><span class="fa fa-heart"></span></a>
...
href="/Day6/frontend/pages/viewCart.php">View Cart</a>.`;
